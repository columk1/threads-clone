...
const Image: FunctionComponent<ImageProps> = ({ className }) => {
  return (
    <svg aria-label="Attach media" role="img" viewBox="0 0 24 24" className={className} fill="currentColor" height="20px" width="20px">
      ...
      <defs><clipPath id=":r7l:"><rect fill="white" height="17" rx="4.5" width="17" x="6" y="5.1394"></rect></clipPath></defs>
    </svg>
  )
}
