...
const Report: FunctionComponent<ReportProps> = ({ className }) => {
  return (
    <svg aria-label="" role="img" viewBox="0 0 24 24" fill="currentColor" height="20px" width="20px" className={className}>
      <title></title>
