...
type NotificationsFooterProps = {
  className?: string
  isActive?: boolean
}

const NotificationsFooter: FunctionComponent<NotificationsFooterProps> = ({ className, isActive }) => {
  return (
    <svg aria-label="Notifications" role="img" viewBox="0 0 26 26" fill={isActive ? 'currentColor' : 'transparent'} className={className}>
