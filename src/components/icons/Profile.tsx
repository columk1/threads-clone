...
const Profile: FunctionComponent<ProfileProps> = ({ className, isActive }) => {
  return (
    <svg aria-label="Profile" role="img" viewBox="0 0 26 26" fill={isActive ? 'currentColor' : 'transparent'} height="24px" width="24px" className={className}>
      <title>Profile</title>
      <circle cx="13" cy="7.25" r="4" stroke="currentColor" strokeWidth="2.5"></circle>
